					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 343899504</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> tranahuy247@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					...
					<div class="col-sm-5">
						...
						<div class="search_box pull-right">
							...
							<input type="submit" style="margin-top:0;color:#666" class="btn btn-primary btn-sm"name="search_items" value="Tìm kiếm">
						</div>
					</form>
					</div>
				</div>
